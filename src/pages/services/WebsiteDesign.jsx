...
const WebsiteDesign = () => {
  ...
  const serviceFeatures = [
    ...
    },
    {
      ...
      title: "Rich Image",
      subtitle: "Editing",
      description: "High-quality images are the backbone of a professional website. Our rich image editing services enhance your visuals to ensure they are crisp, vibrant, and on-brand. From color correction and background cleanup to retouching and optimization, we make sure every image contributes to a polished and cohesive look across your website."
    },
    {
      
      title: "Our",
      subtitle: "Expertise",
      description: `To deliver exceptional results, we leverage industry-leading design tools and development platforms.
      • Design Tools: We use Adobe Illustrator, Corel Draw, InDesign, Adobe Photoshop, and Adobe Dreamweaver to craft precise, professional, and visually striking designs. 
      • Development Platforms: Our development expertise spans WordPress, Shopify, Magento, and NetSuite, allowing us to build websites that are not only beautiful but also functional, responsive, and scalable. `
    }
   ];
  return (
    <>
