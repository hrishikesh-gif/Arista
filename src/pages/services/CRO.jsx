  ...
  const serviceFeatures = [
    {
      title: "Why CRO",
      subtitle: "Matters​",
      description: `Even with high traffic, a website that doesn’t convert can’t grow your business. Our CRO services ensure:
      • Higher conversions without increasing ad spend
      • Better ROI on every marketing campaign
      • Improved user experience that keeps customers coming back`
    ...
    },
    {
      ...
      description: "We create and test multiple landing page versions to identify the elements that drive the highest conversions. Headlines, images, forms, and CTAs are all optimized to turn visitors into leads or customers.          "
    },
    {
      
      title: "CTA Testing",
      subtitle: "& Optimization",
      description: "A single call-to-action can make or break a campaign. We experiment with placement, copy, color, and design to ensure every CTA gets the maximum clicks and conversions."
    },
    {
      
      title: "Funnel",
      subtitle: "Performance Review",
      description: "We analyze every step of your user journey, from landing page to checkout or sign-up. Identifying bottlenecks and friction points allows us to optimize your funnels for smoother, faster conversions."
    },
    {
      
      title: "Experiment-Based",
      subtitle: "Scaling",
      description: "Our approach is rooted in real data. We run controlled experiments to test new ideas, ensuring that every change leads to measurable growth."
    },
    {
      
      title: "Multichannel",
      subtitle: "Attribution & Analytics",
      description: "We track the impact of every channel on your conversion rate. From paid ads to organic traffic, we measure performance, assign value, and prioritize strategies that deliver the highest ROI."
    },
    {
