...
const CustomerService = () => {
  ...
  const serviceFeatures = [
    ...
    }, 
    {
      ...
      description: `
      • Proven Amazon marketplace management services that drive results. 
      • Shorten the learning curve with AI-powered optimization. 
...
"
          >
            Boost Your Sales. Dominate the Marketplace!
          </motion.h3>

          <div className="mt-4 sm:mt-6 md:mt-8 w-full md:max-w-2xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-6xl">
            <TypewriterText
              text="Amazon and other online marketplaces are crowded. Without the right strategy, your products can get lost. At Arista Systems, we help brands stand out with Amazon marketplace services and amazon marketplace management services designed to grow sales, optimize listings, and improve visibility."
