  ...
  const serviceFeatures = [
    {
      ...
      • White Background: Clean, distraction-free, and consistent product presentation. 
      • Lifestyle Images: Show products in real-life settings to engage buyers. 
      • Infographics & Overlays: Highlight key features and benefits clearly. 
      • Dust & Blemish Cleanup: Remove imperfections for flawless visuals. 
      • Enhancements: Add shadows, reflections, and subtle retouching.`
    },
    {
    ...
    },
    {
      ...
      description: "Connect with shoppers on a personal level. We create compelling narratives that communicate your brand values, mission, and vision while visually integrating your products. A strong brand story differentiates you from competitors and fosters long-term loyalty."
    },
    {
    ...
    },
    {
      ...
      subtitle: "Essentials",
      description: `Lay a solid foundation with Amazon Brand Registry. We guide you through registration, protect your brand, secure exclusive content, and unlock enhanced marketing tools to boost visibility and credibility. 
      
      With our integrated approach, your Amazon presence becomes a powerful sales tool, combining visual perfection, engaging content, and a compelling brand story to increase trust, engagement, and conversions.`
    },
