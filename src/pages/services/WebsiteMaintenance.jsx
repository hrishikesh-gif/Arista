      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="mx-auto w-full max-w-7xl px-6 sm:px-8 py-16">
          ...
          <h1 className="mt-3 text-5xl sm:text-6xl lg:text-[76px] leading-[1.05] font-semibold">
            <span className="bg-gradient-to-r from-sky-400 to-sky-200 bg-clip-text text-transparent">Website Maintenance &</span>{" "}
            <span className="bg-gradient-to-r from-fuchsia-300 to-rose-300 bg-clip-text text-transparent">Product Launch Ops</span>
          </h1>
