  ...
  const serviceFeatures = [
    {
      ...
      title: "Architectural",
      subtitle: "Design",
      description: "Design Spaces That Speak for You. Why settle for ordinary when your space can stand out? Our architects create environments that are structurally solid, visually compelling, and aligned with your goals. From initial sketches to detailed blueprints, every element is designed to impress and perform."
    },
    {
      
      title: "Interior",
      subtitle: "Design",
      description: "Interiors That Reflect Your Vision A beautiful interior isn’t just decoration it’s an experience. Our team ensures layouts, lighting, and aesthetics match your style while enhancing usability, making your space both stunning and functional."
    },
    {
      
      title: "3D Rendering",
      subtitle: "Services",
      description: "See It Before It Exists Stop guessing how your project will look. Our photorealistic 3D renderings show every angle, detail, and finish, helping you make confident decisions, impress stakeholders, and avoid costly mistakes"
    },
    {
      
      title: "Why Choose",
      subtitle: "Arista Systems?",
      description: `
      • End-to-End Expertise: From concept to final visualization, we handle everything. 
      • Cutting-Edge Technology: Our rendering tools bring unmatched clarity and realism. 
      • Tailored Solutions: Every project is customized to match your vision and needs.`
    },
...
"
          ...
          <div className="mt-4 sm:mt-6 md:mt-8 w-full md:max-w-2xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-6xl">
            <TypewriterText
              text="Are you still imagining your dream project on paper while others are already bringing theirs to life?” At Arista Systems, we turn ideas into reality with precision and creativity. Whether it’s a residential space, commercial project, or interior transformation, our architectural and rendering services give you designs that are not only functional but truly inspiring."
