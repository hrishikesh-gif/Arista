...
const PhilosophySection = () => {
  ...
  return (
    <>
      ...
      <div className="philosophy-section min-h-screen bg-[#0a0118] p-4 sm:p-6 md:p-8 lg:p-10">
        <div className="max-w-[1400px] mx-auto">
          {/* Header Section */}
          <div className="mb-8 sm:mb-10 md:mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 sm:mb-12 md:mb-16">
              Our Philosophy
            </h1>
            
            {/* Mission & Vision Cards */}
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-8 sm:mb-10 md:mb-12">
              {/* Mission Card */}
              <div 
                className="philosophy-card group relative"
                style={{ '--card-gradient': '132, 0, 255' }}
              >
                <div className="relative bg-[#0f0820] rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 border border-[#2e1a4e] transition-all duration-300">
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Our Mission</h2>
              ...
              >
                <div className="relative bg-[#0f0820] rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 border border-[#2e1a4e] transition-all duration-300">
                  <h2 className="text-xl sm:text-2xl font-bold text-white mb-2 sm:mb-3">Our Vision</h2>
                  <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
          ...
          {/* Bento Grid */}
          <div ref={gridRef} className="card-grid grid gap-3 sm:gap-4 auto-rows-[220px] sm:auto-rows-[240px] md:auto-rows-[260px] lg:auto-rows-[280px]">
            {philosophyItems.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className="relative h-full bg-[#0f0820] rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 border border-[#2e1a4e] transition-all duration-300 flex flex-col justify-between overflow-hidden">
                    {/* Header */}
                      ...
                      {item.features && item.features.length > 0 && (
                        <ul className="space-y-1 sm:space-y-2 mt-auto">
                          {item.features.map((feature, idx) => (
                            <li key={idx} className="flex items-center gap-2 text-[10px] sm:text-xs text-gray-500">
                              <svg 
