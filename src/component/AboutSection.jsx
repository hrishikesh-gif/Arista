...
const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-black to-purple-900"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="mb-8">
                <div className="flex flex-wrap items-center gap-4 mb-4">
                  <span className="text-2xl md:text-4xl font-bold text-white bg-white/10 px-4 py-2 rounded-lg">Strategic</span>
                  <span className="text-2xl text-purple-400">→</span>
                  <span className="text-2xl md:text-4xl font-bold text-white bg-white/10 px-4 py-2 rounded-lg">Collaborative</span>
                </div>
                <div className="flex flex-wrap items-center gap-4 mb-4">
                  <span className="text-2xl md:text-4xl font-bold text-white bg-white/10 px-4 py-2 rounded-lg">Innovative</span>
                  <span className="text-2xl text-purple-400">→</span>
                  <span className="text-2xl md:text-4xl font-bold text-white bg-white/10 px-4 py-2 rounded-lg">Agile</span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-2xl md:text-4xl font-bold text-white bg-white/10 px-4 py-2 rounded-lg">Seasoned</span>
                </div>
              </div>
            ...
            <div className="flex gap-4">
              <button className="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">
                Learn More
              </button>
              <button className="px-8 py-3 border border-purple-400 text-purple-400 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300">
                View Projects
              </button>
            </div>
          </div>
