    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          className="text-sm md:text-base tracking-[0.3em] text-neutral-400 uppercase mb-8 font-light"
        >
           We Are
        </motion.p>
        ...
        <motion.div
          ...
          animate={isInView ? { width: "120px", opacity: 1 } : { width: 0, opacity: 0 }}
          transition={{ delay: 0.7, duration: 1, ease: "easeOut" }}
          className="h-[2px] bg-white/80 mx-auto mb-12"
        />
        ...
        <motion.p
          ...
          className="text-xl md:text-3xl text-neutral-300 font-light mb-12 tracking-wide"
        >
        ...
        <motion.p
          ...
          className="text-base md:text-lg text-neutral-400 leading-relaxed max-w-3xl mx-auto font-light"
        >
